...
export default class PanZoomDrawListener extends React.Component {
  ...
  updateShapePositionByTypeAndAction(action, ax, ay, aw, ah, px, py) {
    ...
    switch (type) {
      ...
      case 'image': {
        newAnnotation = ImageDrawComponent.transformPointsByAction(
          annotationInfo, action,
          px, py, ax, ay, aw, ah,
          this.initialX, this.initialY,
          slideWidth, slideHeight,
  ...
  sendUpdateAnnotation(annotation) {
    ...
    switch (annotation.annotationInfo.type) {
      ...
      case 'image':
        return this.handleDrawImage(
          { x: annotation.annotationInfo.x, y: annotation.annotationInfo.y },
          annotation.annotationInfo.imageWidth,
          annotation.annotationInfo.imageHeight,
          annotation.status,
          annotationId,
          annotation.annotationInfo.src,
        );
      default:
  ...
  handleDrawImage(startPoint, width, height, status, id, src) {
